  ...
  if (active && payload?.length) {
    return (
      <div className="bg-white border border-gray-100 shadow-lg rounded-xl px-2 sm:px-3 py-1.5 sm:py-2 text-[10px] sm:text-xs">
        <div className="font-semibold text-gray-600 mb-0.5">{label}</div>
        <div className="text-blue-600 font-bold text-[11px] sm:text-xs">₹{(payload[0].value / 100000).toFixed(2)}L</div>
      </div>
    );
  }
  return null;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 sm:p-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 sm:mb-6 gap-3">
        <div>
          <h1 className="text-base sm:text-[18px] font-bold text-gray-900">
            Welcome back, Demo Store! <span className="text-lg sm:text-xl">👋</span>
          </h1>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-white border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 w-full sm:w-auto">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[9px] sm:text-[10px] text-gray-400">MID: M12345678</div>
            </div>
          ...
          },
          {
            ...
            sub: (
              <span className="flex items-center gap-1 flex-wrap">
                <span className="text-gray-400 text-[10px] sm:text-xs">vs yesterday</span>
                <span className="text-green-500 font-semibold text-[10px] sm:text-xs">↑ 1.25%</span>
              </span>
            ),
          },
        ].map((c, i) => (
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-4 sm:mb-5">
        ...
        <button className="flex items-center justify-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-xl text-[11px] sm:text-xs text-gray-500 hover:bg-gray-50 transition-colors sm:ml-auto">
        ...
        <div className="flex-1 lg:flex-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-5">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-base sm:text-xl font-bold text-gray-900">12,450</span>
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-5">
        ...
        <div className="flex-1 lg:flex-2 grid grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4">
            ...
            <div className="text-base sm:text-lg font-bold text-gray-900">₹12.50 Lakh</div>
            <div className="text-[10px] sm:text-xs text-gray-400 mt-0.5">320 Transactions</div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4">
            ...
            <div className="text-[10px] sm:text-xs text-amber-500 font-semibold mt-0.5">Requires attention</div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4">
            ...
            <div className="text-[10px] sm:text-xs text-red-500 font-semibold mt-0.5">This Month</div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[11px] sm:text-xs text-gray-800 font-medium">Avg. Processing Time</span>
            </div>
            <div className="text-base sm:text-lg font-bold text-gray-900">8 Sec</div>
            <div className="flex items-center gap-1 mt-0.5 flex-wrap">
              <span className="text-[10px] sm:text-xs text-gray-400">vs yesterday</span>
              <span className="text-[10px] sm:text-xs text-green-500 font-semibold">↓ 1 Sec</span>
            </div>
          </div>
        </div>
      </div>
